...
const LinkItem = async ({ link }: { link: ShortUrlCount }) => {
  ...
  return (
    <li
      className="lg:p-4 p-1 border border-transparent border-b-[8px] hover:border-secondary hover:shadow-lg rounded-lg"
      key={link.id}
    >
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-10">
          <h3
            className="lg:text-xl text-base font-semibold truncate"
          ...
          <p className="text-gray-500 text-sm truncate">{link.longLink}</p>
        </div>
      ...
      <div className="">
        ...
        <div className="flex items-center gap-4">
          <p className="flex gap-2 items-end text-xs md:text-base">
          ...
          <span>|</span>
          <time className="lg:text-sm text-xs">
